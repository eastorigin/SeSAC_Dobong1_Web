...
// new Date('날짜 문자열')
console.log(new Date('September 21, 2000 09:21:00'))
...
console.log(Math.max(2.5,4,6,10,15));
console.log(Math.ceil(5.1987)); // 올림
console.log(Math.floor(-5.1987)); // 내림
...
// 각각 key와 value를 뽑아서 "배열"로 변환하는 객체의 메소드

...
/* let
    - 재선언 불가능
    - 재할당 가능
    - 초기화 작업 필요 없음 (최초 선언시 값 할당하지 않아도 됨)
*/
...
// || (OR 연산자는 true일 확률이 높은 조건을 앞쪽에 배치): 엔터 위 버튼 Shift 누른 채로 누르기
console.log(true || true) //true
...
console.log(str1,'는',str2,'에 삽니다.') // , 사이에 띄어쓰기가 자체적으로 들어감
console.log(`${str1}는 ${str2}에 삽니다.`) // 백틱(`)은 물결포 키 (Esc 밑)

...
public class ArrayEx {
    public static void main(String[] args) {
        ...
        String[] temp = null; // 참조형 타입, null로 초기화 할 수 있음
        // System.out.println(tmep);
        // System.out.println(temp[0]);

        int[] intArray = {10, 20, 25, 44, 55};
        ...
        char[] charArray;
        // charArray = {'A', 'a'}; // compile error. 선언시 초기화 안 했을 때
        ...
        System.out.println("변경 후: " + Arrays.toString(doubleArray)); // [0.1, 0.4, 0.6]

        //     다차원 배열
        // 배열 생성과 초기화 (2X3)
        int[][] matrix = {{1, 2, 3}, {4, 5, 6}};
        System.out.println("이차원 배열: " + matrix[0][0]); // 1
        ...
        //     이중 포문을 이용해서 배열의 모든 요소 확인 (matrix2만 확인)
        ...
        /*
         * Object rec: 원본 배열 (originArray)
         * int srcPos: 원본 배열 복사 시작 인덱스
         * Object dest: 새로운 배열 (newArray)
         * int desPost: 새 배열 붙여넣기 시작 인덱스
        ...
        System.out.println("copiedArr>>> " + Arrays.toString(copiedArr2)); // [1, 2, 3, 4, 5, 0]
        ...
        System.out.println("after fill>> " + Arrays.toString(filledArr)); // [10, 10, 10, 10, 10]
        ...
        System.out.println("===== deepEquals 사용 =====");

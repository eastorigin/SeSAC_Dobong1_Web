...
public class ArrayListEx {
    public static void main(String[] args) {
        ...
        //     3. index로 요소 접근
        // System.out.println(numbers[0]); // 이렇게 접근하면 안 됨
        System.out.println("0번째 index 확인: " + numbers.get(0)); // 10

        //     4. index로 요소 수정
        // numbers[1] = 77;
        // numbers.set(index 번호, 바꿀 값)
        numbers.set(1, 77);
        System.out.println("요소 변경 후: " + numbers);
        ...
        //     6. ArrayList끼리 연결: arrList1.addAll(arrList2)
        ...
        //     요소의 위치 찾기 indexOf(value): 리턴값은 value에 대한 index 번호
        ...
        //     9. 리스트의 크기 확인
        // System.out.println(numbers.length); // length는 사용하면 안 됨
        System.out.println("numbers ArrayList의 크기: " + numbers.size());

        //     10. 모든 요소 출력: for-each문 사용해서 (numbers)

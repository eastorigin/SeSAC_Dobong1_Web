...
public class Student {
    ...
    public Student(String name, int g) {
        //     Student s1 = new Student("allie");
        //     생성자의 인자를 이용해서 클래스의 필드를 초기화할 수 있다!
        this.name = name; // 클래스의 변수 초기화

        // this 키워드를 사용하지 않아도 초기화가 가능하지만 의미를 명확하게 하기 위해 this를 작성하는게 일반적
        grade = g;
    }
    ...
    public String getTestResult(int score) { // 반환값 o, 매개변수 o

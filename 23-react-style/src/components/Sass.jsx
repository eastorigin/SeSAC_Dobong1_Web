...
import img1 from "../assets/짱구는못말려.jpg";
...
export default function Sass() {
  return (
    <>
      ...
      <img
        src="/assets/짱구는못말려.jpg"
        alt="경로명으로 접근가능, public 폴더는 static 폴더이기 때문에 /로 접근"
      />
      <img
        src={process.env.PUBLIC_URL + "/assets/짱구는못말려.jpg"}
        alt="경로명으로 접근가능, public 폴더는 static 폴더이기 때문에 /로 접근"
      />
      <h5>css 파일에서 이미지 접근(background-image 속성)</h5>
      ...
      <div className="practice2">
        <div className="practiceCircle2"></div>
        <div className="practiceCircle2"></div>
        <div className="practiceCircle2"></div>
      </div>
